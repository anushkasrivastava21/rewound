...
const Dandelion = dynamic(
  () => import("@/components/memories/Dandelion"),
  { ssr: false }
);

function DandelionContent() {
  const [isTransitioning, setIsTransitioning] = useState(true);
  const tape = TAPES.find(t => t.memoryType === "dandelion") || TAPES.find(t => t.label.toLowerCase().includes("dandelion")) || TAPES[3];
