...
const CloudWatching = dynamic(
  () => import("@/components/memories/CloudWatching"),
  { ssr: false }
);

function CloudWatchingContent() {
  const [isTransitioning, setIsTransitioning] = useState(true);
  const tape = TAPES.find(t => t.memoryType === "cloud-watching") || TAPES.find(t => t.label.toLowerCase().includes("cloud")) || TAPES[2];
...
export default function CloudWatchingPage() {
  return (
