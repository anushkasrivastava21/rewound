...
const EtchASketch = dynamic(
  () => import("@/components/memories/EtchASketch"),
  { ssr: false }
);

function EtchASketchContent() {
  const [isTransitioning, setIsTransitioning] = useState(true);
  const tape = TAPES.find(t => t.memoryType === "etch-a-sketch") || TAPES.find(t => t.label.toLowerCase().includes("sketch")) || TAPES[1];
