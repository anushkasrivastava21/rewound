...
const PaperBoats = dynamic(
  () => import("@/components/memories/PaperBoats"),
  { ssr: false }
);

function PaperBoatsContent() {
  const [isTransitioning, setIsTransitioning] = useState(true);
  const tape = TAPES.find(t => t.memoryType === "paper-boats") || TAPES.find(t => t.label.toLowerCase().includes("paper")) || TAPES[4];
...
export default function PaperBoatsPage() {
  return (
